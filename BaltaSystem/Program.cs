...
namespace BaltaSystem
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            var careerItem02 = new ContentContext.CareerItem(2, "Começando com C#", "", courseCsharp);
            var careerItem01 = new ContentContext.CareerItem(1, "Introdução da Carreira", "", courseDotnet);
            var careerItem03 = new ContentContext.CareerItem(3, "Introdução da OOP", "", courseOOP);
